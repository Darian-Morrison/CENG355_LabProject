...
void mySPI1_SendData(unsigned char data){
	...
	GPIOA->BSRR = ((uint16_t)0x0100);
	wait(100);
}

//Sends 1 byte of data to LCD( Either command or code to be displayed)
void myLCD_SendData(unsigned char data, unsigned char RS){
